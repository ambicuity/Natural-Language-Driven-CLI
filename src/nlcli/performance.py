        ...
        with self._lock:
            ...
            return {
                ...
                "memory_stats": {
                    ...
                    "high_usage_operations": len([m for m in memory_usage if m > self.memory_warning_threshold])
                },
                "cpu_stats": {
                    "avg_percent": sum(cpu_usage) / len(cpu_usage),
                    "max_percent": max(cpu_usage),
                    "high_usage_operations": len([c for c in cpu_usage if c > self.cpu_warning_threshold])
                },
