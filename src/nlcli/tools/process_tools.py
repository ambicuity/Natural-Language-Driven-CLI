...
def get_process_tools() -> List[ToolSchema]:
    ...
    return [
        ...
        ToolSchema(
            ...
            examples=[
                {
                    "nl": "list running processes", 
                    "args": {"sort": "cpu"}
                },
                {
                    "nl": "show processes by memory usage",
                    "args": {"sort": "mem"}
                },
                {
                    "nl": "processes using port 3000",
                    "args": {"port": 3000}
                }
            ],
        ...
        ToolSchema(
            ...
            examples=[
                {
                    "nl": "what's using port 3000",
                    "args": {"port": 3000}
                },
                {
                    "nl": "process on port 8080",
                    "args": {"port": 8080}
                },
                {
                    "nl": "find process using port 443",
                    "args": {"port": 443}
                }
            ],
        ...
        ToolSchema(
            ...
            generator={
                "cmd": "kill -{signal} {target}",
                "clauses": {}
            },
            danger_level="destructive",
            examples=[
                {
                    "nl": "kill process 1234",
                    "args": {"pid": 1234}
                },
                {
                    "nl": "terminate nginx process",
                    "args": {"name": "nginx"}
                },
                {
        ...
        ToolSchema(
            ...
            examples=[
                {
                    "nl": "show process tree",
                    "args": {}
                },
                {
                    "nl": "process tree for user john",
                    "args": {"user": "john"}
                }
            ],
        ...
        ToolSchema(
            ...
            args={
                "detailed": ToolArg("detailed", "boolean", default=False)
            },
            generator={
            ...
            examples=[
                {
                    "nl": "show system resources",
                    "args": {}
                },
                {
                    "nl": "cpu and memory usage",
                    "args": {}
                },
                {
                    "nl": "system load",
            ...
            keywords=["system", "cpu", "memory", "load", "resources", "usage", "top", "free"]
        )
    ]