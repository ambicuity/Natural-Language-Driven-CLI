    ...
    return [
        ...
        ToolSchema(
            ...
            examples=[
                ...
                {
                    "nl": "show all files including hidden",
                    "args": {"all": True}
                },
                {
                    "nl": "list files sorted by size",
                    "args": {"sort": "size"}
                }
            ],
        ...
        ToolSchema(
            ...
            keywords=["search", "grep", "find", "content", "text", "contains", "containing", "pattern", "TODO", "import"]
        ),
        ...
        ToolSchema(
            ...
            generator={
                ...
                "conversions": {
                    "follow_links": lambda x: "-L" if x else ""
                }
            },
            danger_level="read_only",
            examples=[
                {
                    "nl": "file info for README.md",
                    "args": {"path": "README.md"}
                },
                {
                    "nl": "get details about that file",
                    "args": {"path": "{context}"}
                }
            ],
