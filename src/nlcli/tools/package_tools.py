...
def get_package_tools() -> List[ToolSchema]:
    ...
    return [
        ...
        ToolSchema(
            ...
            examples=[
                {
                    "nl": "info about python package",
                    "args": {"package": "python"}
                },
                {
                    "nl": "brew info for nodejs",
                    "args": {"package": "nodejs"}
                }
            ],
        ...
        ToolSchema(
            ...
            args={
                "versions": ToolArg("versions", "boolean", default=False)
            },
            generator={
                "cmd": "brew list {versions_flag}",
                "clauses": {}
            },
            danger_level="read_only",
            examples=[
                {
                    "nl": "list installed packages",
                    "args": {}
                },
                {
                    "nl": "show brew packages with versions",
                    "args": {"versions": True}
                }
            ],
        ...
        ToolSchema(
            ...
            examples=[
                {
                    "nl": "search for python in apt",
                    "args": {"package": "python"}
                },
                {
                    "nl": "find nginx package",
                    "args": {"package": "nginx"}
                }
            ],
        ...
        ToolSchema(
            ...
            examples=[
                {
                    "nl": "apt info for python3",
                    "args": {"package": "python3"}
                },
                {
                    "nl": "package details for nginx",
                    "args": {"package": "nginx"}
                }
            ],
        ...
        ToolSchema(
            ...
            args={
                "upgradable": ToolArg("upgradable", "boolean", default=False)
            },
            generator={
            ...
            examples=[
                {
                    "nl": "list installed apt packages",
                    "args": {}
                },
                {
                    "nl": "show upgradable packages",
