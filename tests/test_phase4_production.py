...
from nlcli.security import (
    SecurityAuditor, SecurityLevel, VulnerabilityType, SecurityPolicy,
    CommandSanitizer, audit_command_security
)
from nlcli.performance import (
    PerformanceProfiler, PerformanceCache, ResourceMonitor,
    cached, profile_operation
)
from nlcli.error_recovery import (
    ErrorClassifier, ErrorRecoveryManager, ErrorCategory, ErrorSeverity,
    ErrorContext, RetryConfig, with_retry, graceful_fallback
)
from nlcli.telemetry import (
    TelemetryManager, MetricsCollector, EventLogger, SessionManager,
    MetricType, EventType, get_telemetry_manager
)
from nlcli.enterprise import (
    EnterpriseManager, RoleBasedAccessControl, AuditLogger, PolicyEngine,
    Role, Permission, User, get_enterprise_manager
)
...
class TestSecurity(unittest.TestCase):
    ...
    def test_command_injection_detection(self):
        ...
        injection_violations = [v for v in violations 
    ...
    def test_path_traversal_detection(self):
        ...
        violations = self.auditor.audit_command(intent, self.context)
        traversal_violations = [v for v in violations 
    ...
    def test_privilege_escalation_detection(self):
        ...
        violations = self.auditor.audit_command(intent, self.context)
        escalation_violations = [v for v in violations 
    ...
    def test_security_report_generation(self):
        ...
        intent = Intent(tool_name="test", command="sudo ls", args={}, explanation="Test sudo command")
...
class TestEnterprise(unittest.TestCase):
    ...
    def test_rbac_permissions(self):
        ...
        has_execute = self.rbac.user_has_permission(self.test_user, Permission.EXECUTE_COMMAND)
        self.assertTrue(has_execute)
        
        has_manage_users = self.rbac.user_has_permission(self.test_user, Permission.MANAGE_USERS)
        ...
        has_manage_users = self.rbac.user_has_permission(admin_user, Permission.MANAGE_USERS)
    ...
    def test_policy_engine(self):
        ...
        result = self.policy_engine.evaluate_command("rm -rf dangerous_file", self.test_user)
        
        # Should have violations due to dangerous command
        self.assertIn("violations", result)
        
        # Test file access evaluation
        file_result = self.policy_engine.evaluate_file_access("/etc/passwd", "read", self.test_user)
    ...
    def test_configuration_management(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.json', delete=False) as f:
            ...
            # Test default values
            default_value = config_manager.get_config_value("nonexistent.setting", "default")
...
class TestIntegration(unittest.TestCase):
    ...
    def test_enhanced_safety_check(self):
        ...
        # Test safe command
        safe_intent = Intent(tool_name="ls", command="ls -la", args={}, explanation="List files")
        is_safe, message, violations = enhanced_safety_check(safe_intent, context)
        self.assertTrue(is_safe)
        
        # Test dangerous command
        dangerous_intent = Intent(tool_name="rm", command="rm -rf /", args={}, explanation="Remove all files")
