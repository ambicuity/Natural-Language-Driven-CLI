...
from nlcli.language import (
    LanguageConfig, LanguageDetector, SimpleTranslator, 
    MultiLanguageProcessor, create_language_processor, get_language_processor
)
...
class TestLanguageSupport(unittest.TestCase):
    ...
    @patch.dict(os.environ, {'NLCLI_DEFAULT_LANG': 'es', 'NLCLI_ENABLED_LANGUAGES': 'en,es,fr'})
